    ...
    public Map<String, Object> getApiDocs() {
        ...
        try {
            Map<String, Object> instituto =
                    restTemplate.getForObject("http://instituto-service:8081/v3/api-docs", Map.class);

            Map<String, Object> matricula =
                    restTemplate.getForObject("http://matricula-service:8082/v3/api-docs", Map.class);
